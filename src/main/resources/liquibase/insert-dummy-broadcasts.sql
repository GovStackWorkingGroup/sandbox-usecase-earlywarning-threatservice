...
VALUES (nextval('broadcast_id_seq'), '7a39af99-5ede-4cfd-a56a-c7737937d5a0', 1, 1, 'Kenya', 'Heavy Rain', 'PENDING', '', 'SMS', 'Flooding expected',
       ...
       (nextval('broadcast_id_seq'), 'f479a05f-5f4c-4b9f-97a0-51ff7d7b9bba', 7, 1, 'Kenya', 'Wind Advisory', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'a8451b1d-29a7-4421-8364-35b1be49e87e', 9, 2, 'Somalia', 'Flash Flood', 'PENDING', '', 'EMAIL',
       ...
       (nextval('broadcast_id_seq'), 'd82c9778-6fe2-42a6-bb8b-bcf23065048d', 11, 4, 'South Sudan', 'Hailstorm', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), '7b6e1e6e-cbd4-46ae-a9b5-13cb132f7adf', 13, 1, 'Kenya', 'Severe Heat', 'PENDING', '', 'EMAIL', 'Unbearable heat',
       ...
       (nextval('broadcast_id_seq'), 'cb3c16b7-4d47-40c5-8a1f-9e049d99fc6b', 17, 4, 'South Sudan', 'Rainstorm', 'PENDING', '', 'EMAIL',
       ...
       (nextval('broadcast_id_seq'), '12d13b56-222d-4d5f-b903-23355d93d8fe', 19, 1, 'Kenya', 'Tropical Cyclone', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'e6a52eb2-2767-4a02-aba5-f756b7d1bb8d', 22, 3, 'Uganda', 'Dense Fog', 'SENT', '', 'EMAIL', 'Visibility reduced',
        'Lorem ipsum text', NOW(), NOW(), '2024-02-05', '2024-02-10', '19dac117-3242-4331-b0b4-1e4393e083d4'),
       (nextval('broadcast_id_seq'), 'f7f4d964-61f3-4ae1-9a82-dfb3198bd5d7', 23, 4, 'South Sudan', 'Extreme Heat', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), '12a73c48-3a58-49b3-9c88-4858e6dc1f58', 29, 4, 'South Sudan', 'Extreme Cold', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'fa7d2316-0070-4039-9c66-87dfb71e6c94', 33, 2, 'Somalia', 'Extreme Winds', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'aab47f6e-3abf-431e-bf93-58e8e8e10f87', 35, 4, 'South Sudan', 'Wildfire Risk', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'f1d34a62-bc7d-4d7b-827f-4efb81d3f4ff', 39, 2, 'Somalia', 'Tropical Depression', 'PENDING', '', 'EMAIL',
       ...
       (nextval('broadcast_id_seq'), '9d3c8eb1-6587-49b3-89b7-d0c70bfb2341', 1, 4, 'South Sudan', 'Landslide Alert', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'b8f847f1-8731-46b7-8a10-6eb733c9bcfc', 3, 1, 'Kenya', 'Heat Warning', 'PENDING', '', 'EMAIL', 'Prolonged heatwave',
       ...
       (nextval('broadcast_id_seq'), 'd67b2d18-8c1a-4bbd-8dc4-27d5e3e01f09', 7, 4, 'South Sudan', 'Severe Heat Alert', 'PENDING', '', 'EMAIL',
       ...
       (nextval('broadcast_id_seq'), 'c8e9b4a2-9c3b-40b8-9c8f-5b3a87d5c9f0', 11, 2, 'Somalia', 'Hail Alert', 'PENDING', '', 'TELEGRAM', 'Hailstorm risk',
       ...
       (nextval('broadcast_id_seq'), '3b2c8e6d-9f5b-49b2-8c1f-7e3d9b4c8b8c', 13, 4, 'South Sudan', 'Freezing Temps', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), '9d3c8e4b-5f7a-4c9b-8a6d-3e7d2f5a8b6f', 21, 1, 'Kenya', 'Thunder Alert', 'PENDING', '', 'TELEGRAM',
       ...
       (nextval('broadcast_id_seq'), '5d4c8e7a-3f2b-1e6d-9a4f-7e9f2a5b8c6f', 23, 2, 'Somalia', 'Winter Storm', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), 'a4e7b9e1-2b4f-4e8f-9e6f-3a8e1f2e5c9b', 25, 4, 'South Sudan', 'Wildfire Risk', 'PENDING', '', 'EMAIL',
       ...
       (nextval('broadcast_id_seq'), '2c8d5f9a-1e2a-3f5d-9e8e-7f7d3b6e2d9f', 27, 1, 'Kenya', 'Flood Risk', 'PENDING', '', 'TELEGRAM',
       ...
       (nextval('broadcast_id_seq'), '3a7e9d6a-2f6c-9e1a-8c5e-4a7d8b3a5b9d', 29, 2, 'Somalia', 'Flooding Risk', 'PENDING', '', 'WHATSAPP',
       ...
       (nextval('broadcast_id_seq'), '6c7b3d2e-9c2a-4e9f-b1d4-8a4e5f6c8d3f', 35, 2, 'Somalia', 'Frost Warning', 'PENDING', '', 'TELEGRAM',
       ...
       (nextval('broadcast_id_seq'), '9f3c6e4a-4f7b-8d2f-3e7a-9c1f6b7a3c7f', 37, 4, 'South Sudan', 'Sandstorm Alert', 'PENDING', '', 'EMAIL',
       ...
       (nextval('broadcast_id_seq'), '4f2c8d3b-7a5e-4a9d-b2c9-9c6d8e1f6b7f', 39, 1, 'Kenya', 'Wind Chill Warning', 'PENDING', '', 'WHATSAPP',
