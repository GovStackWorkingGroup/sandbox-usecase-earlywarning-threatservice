...
(
    id          BIGINT       NOT NULL DEFAULT NEXT VALUE FOR threat_id_seq PRIMARY KEY,
...
(
    id                   BIGINT       NOT NULL DEFAULT NEXT VALUE FOR broadcast_id_seq PRIMARY KEY,
...
(
    id          BIGINT       NOT NULL DEFAULT NEXT VALUE FOR country_threat_id_seq PRIMARY KEY,
    threat_id   BIGINT       NOT NULL,
    countryId   BIGINT       NOT NULL,
    countryName VARCHAR(255) NOT NULL,
    FOREIGN KEY (threat_id) REFERENCES threat (id)
...
(
    id                BIGINT       NOT NULL DEFAULT NEXT VALUE FOR county_country_id_seq PRIMARY KEY,
